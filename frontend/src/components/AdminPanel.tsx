...
export const AdminPanel = () => {
  ...
  } = usePendingTools(shouldFetchPending ? adminToken : null);
      ...
      <div className="min-h-screen bg-gradient-to-br from-dark-bg via-dark-surface to-dark-bg p-5">
        <div className="max-w-screen-xl mx-auto">
          <div className="glass-card p-8">
            <h1 className="text-4xl mb-3 text-white font-bold">Admin Panel</h1>
            <p className="text-gray-400 text-sm mb-6">
              Enter your admin token to access tool management features
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-bg via-dark-surface to-dark-bg p-5">
      <div className="max-w-screen-xl mx-auto">
        <div className="glass-card p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Manage AI tools and approve auto-detected tools
              </p>
            </div>
          ...
          {/* Tab Navigation */}
          <div className="flex gap-2 mb-8 border-b border-glass-border pb-4">
            <button
